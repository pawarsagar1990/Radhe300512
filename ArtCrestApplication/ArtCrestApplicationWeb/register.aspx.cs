            ...
            try
            {
                if (validateInput())
                {
                    ...
                    if (insertResult > 0)
                    {
                        ...
                        mailBody.Append("<div><span style = 'color:#1f0a50;font-weight:bold;'> Dear "+ txtFirstName.Text + ",</span><br /><p> Congratulations!! Your Skartif account is now active and we are pleased to have you as our valued customer. You now have access to shop amazing and unique products offered at skartif and we are always on the move to help you find the perfect product; though it be artworks, paintings, gifts, home decor other festive necessities and much more. Go ahead and fill up your kart and be rest assured that your idea of the perfect product will be materialised and delivered to your doorstep only at Skartif.</p></div><hr />");
