        ...
        <section class="reg-sec">
            <div class="container">
                <div class="reg-box">
                    ...
                    <asp:DropDownList class="login-input"  runat="server" ID="drpSuperCategory"></asp:DropDownList>

                    <label for="uname"><b>Product Category</b></label>
                    <asp:DropDownList class="login-input" runat="server" ID="drpCategory"></asp:DropDownList>
